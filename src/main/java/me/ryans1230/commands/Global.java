...
import me.ryans1230.PvPCommand;
import me.ryans1230.PvPLocalisation;
...
public class Global extends PvPCommand {
    ...
    Global(PvPToggle plugin, CommandSender sender) {
        super(plugin, sender);
    }
     ...
     */
    void getGlobalStatus(CommandSender sender) {
    ...
    private void resetGlobal(CommandSender sender) {
        ...
        Collection<? extends Player> players = plugin.getServer().getOnlinePlayers();    // get list of online players
